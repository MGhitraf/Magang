    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="Data_motor/data_motor.php">
              <span class="menu-icon">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    if(!empty($_POST['simpan']))
                    {
                      ...
                      $query = "INSERT INTO yamaha.tbl_product (tanggal_masuk,jml_motor,status,nm_product) VALUES (:tanggal_masuk,:jml_motor,:status,:nm_product)";
                      ...
                      echo '<script>alert("Berhasil Input Data");window.location="data_motor.php"</script>';
                    }
